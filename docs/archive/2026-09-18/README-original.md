# Archived MarketBrain README (superseded 2026-09-18)

Historical evidence only. Follow [the current documentation](../../README.md), not the commands or roadmap below. Historical links may reflect the old repository layout.
