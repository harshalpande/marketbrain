...
Latest scoped delivery E66: [six pre-fit specifications](numerical-prefit-contract.md) plus a machine-readable proposal and six code-consistency tests, combining learner inputs, preprocessing, comparators, temporal evaluation, metrics and artifact/release safeguards. This is not implementation of the ten-feature learner. E65's mapping/spare acceptance stands: 600 rows/150 dates, 0 training-eligible rows. No repeat spare run/rebuild or new Java/data/model call requested. Source policy, evaluation acceptance and fitting approval remain open; dashboard percentages below are unchanged.
