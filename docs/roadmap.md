...
- G02.2 `PARTIAL`: machine-readable draft, bounded history diagnostic runtime verified (E30), pure research-label arithmetic offline verified (E32), feature snapshot runtime verified (E37), bounded calendar windows verified on spare (E39). E40 implements combined stored quality-job/corporate-action/resolution linkage, runtime pending; no acquisition rerun. Price-policy freeze, missing provenance, broader/label-horizon calendar, availability evidence and labelled export remain pending. No training authorization or checkpoint/percentage increase solely for these preparatory slices.
