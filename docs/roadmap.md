...
- G02.2 `PARTIAL`: history (E30), features (E37), calendar (E39), quality linkage (E41), coordinated preflight (E43) verified within scope. E44 implements missing outcome-bar export plus extended quality/action scope and reviewed June/July calendar; runtime pending. Price-policy freeze/provenance, availability/universe policy and multi-date labelled export/frozen splits remain pending. No acquisition rerun, training authorization or checkpoint/percentage increase solely for preparatory slices. Three milestones to first measured baseline and conditional 6–10 working-day post-prerequisite estimate are tracked in the numerical plan; full platform/paper observation separate.
