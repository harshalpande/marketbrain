...
- G02.2 `PARTIAL`: machine-readable draft, bounded history diagnostic runtime verified (E30), pure research-label arithmetic offline verified (E32), feature snapshot runtime verified (E37), bounded calendar windows verified on spare (E39), stored-quality linkage verified (E41). E42 combines offline price/outcome/feature-input/split preflights: four outcome paths arithmetic-only, eight unavailable horizons, four overlapping TRAIN rows purged. Price-policy freeze/provenance, later calendar/bars, availability/universe policy and multi-date labelled export/frozen splits remain pending. No acquisition rerun, training authorization or checkpoint/percentage increase solely for these preparatory slices.
