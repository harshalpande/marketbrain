...
- G02.2 `PARTIAL`: history/features/calendar/quality linkage and outcome paths verified within scope; E47 confirms the 38-date research export on spare (152/152 rows, 3.975s). E48 prepares a provisional 150-date development plan from existing bars; E49 independently verifies its 600 feature/outcome windows against the extended calendar and implements bounded repair recovery, awaiting spare evidence. No new acquisition. Price/availability/universe policy, broader certified export, valid frozen folds and a genuinely untouched evaluation set remain pending. No training authorization or overall percentage increase from preparatory slices. Conditional engineering estimate remains in the numerical plan; full platform/paper observation separate.
