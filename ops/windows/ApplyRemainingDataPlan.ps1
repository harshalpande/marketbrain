...
if ($result.totalItems -ne 331 -or
    ...
    $result.upstoxDailyCandleCount -ne 124858 -or
    $result.secondaryDailyCandleCount -ne 277 -or
    $result.allSourceDailyCandleCount -ne 125135 -or
...
Write-Host 'The original 124858 Upstox candles were not rewritten; 277 NSE BhavCopy candles were added separately.'
